...
class Insert extends \Magento\Framework\App\Action\Action
{
    public function execute()
    {
        ...
        $entities = ['media', 'treatment', 'base_cost_1', 'base_cost_2', 'base_cost_3', 'base_cost_4', 'base_cost_5', 'base_cost_6', 'media_treatment', 'frame_treatment'];
        foreach ($entities as $item) {
            ...
            foreach ($csvData as $row => $data) {
                ...
                if(in_array($item , ['base_cost_1', 'base_cost_2', 'base_cost_3', 'base_cost_4', 'base_cost_5', 'base_cost_6'] )) {
                    $insertData = [
